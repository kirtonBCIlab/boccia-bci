...
{
    public class CustomP300ControllerBehavior : BCIControllerBehavior
    {
                ...
                case FlashPlurality.Multiple:
                    switch (multiFlashPattern)
                    {
                        case MultiFlashPattern.RowColumn:
                            Debug.Log("Row Column Flashing not implemented for Boccia. Use Context Aware instead.");
                            yield return null;
                        break;
                        case MultiFlashPattern.Checkerboard:
                            Debug.Log("Checkerboard Flashing not implemented for Boccia. Use Context Aware instead.");
                            yield return null;
                        break;
